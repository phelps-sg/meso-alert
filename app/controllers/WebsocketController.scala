...
class WebsocketController@Inject()(val controllerComponents: ControllerComponents,
  ...
  extends BaseController with InjectedActorSupport with SameOriginCheck with Logging {
