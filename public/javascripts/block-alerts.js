 ...
 */ !(function (t) {
    ...
    function (t, e, n) {
        ...
        r.env() && (r.location = function () {}),
            (r.ready = function () {
                (p = !0), v ? ((v = !1), l.each(i, h)) : l.each(o, b), l.each(a, b), r.resize.up();
            }),
            (r.load = function (t) {
                T.then(t);
            }),
    ...
    function (t, e, n) {
        ...
        var R = { clone: c, addLast: l, addFirst: d, removeLast: p, removeFirst: v, insert: h, removeAt: E, replaceAt: _, getIn: g, set: y, setIn: m, update: I, updateIn: T, merge: O, mergeDeep: S, mergeIn: b, omit: A, addDefaults: w };
        e.default = R;
    },
    function (t, e) {
        ...
        window.tram = (function (t) {
            ...
            var f = (function (t, e, n) {
                ...
                N = function (t) {
                    ...
                    for (e = 0; e < R.length; e++) if ((n = R[e] + r) in w.style) return { dom: n, css: L[e] + t };
                },
            ...
            var P = (e.frame = (function () {
                ...
                F = f(function (e) {
                    ...
                    (e.init = function (e) {
                        ...
                        C.backface && H.hideBackface && Y(this.el, C.backface.css, "hidden");
                    }),
                        y("add", i),
                        y("start", o),
                        y("wait", function (t) {
    ...
    function (t, e, n) {
        ...
        function ut(t, e) {
            var n = t.actionTypeId,
                ...
                f = void 0 === s || s,
                l = t.rawData;
            if ((r && i && l && u && (l = H({ actionListId: r, actionItemId: i, rawData: l })), ft({ store: e, rawData: l, allowEvents: a, testManual: c }), (r && n === x) || at(n))) {
                mt({ store: e, actionListId: r }), gt({ store: e, actionListId: r, eventId: o });
                var d = It({ store: e, eventId: o, actionListId: r, immediate: u, verbose: f });
                f && d && e.dispatch((0, y.actionListPlaybackChanged)({ actionListId: r, isPlaying: !u }));
            }
        }
        function ct(t, e) {
            var n = t.actionListId;
            n ? mt({ store: e, actionListId: n }) : yt({ store: e }), lt(e);
        }
        function st(t, e) {
            lt(e), V({ store: e, elementApi: m });
        }
        function ft(t) {
            var e,
                n = t.store,
                            ...
                            ? (function (t) {
                                ...
                                if ((0, f.default)(d)) {
                                    (0, v.default)(d, function (t, e) {
                                                        ...
                                                        I.forEach(function (t) {
                                                            ...
                                                            n.forEach(function (t) {
                                                                ...
                                                                if (o) {
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        _[u] = !0;
                                                                        var c = t.config;
                                                                        M({ config: c, event: h, eventTarget: i, elementRoot: a, elementApi: m }).forEach(function (t) {
                                                            ...
                                                            y.forEach(function (t) {
                                                                var n = t.element,
                                                                    ...
                                                                    c = a.actionTypeId,
                                                                    d = J(c) ? tt(c)(n, a) : null,
                                                                    p = j({ element: n, actionItem: a, elementApi: m }, d);
                                                                Tt({
                                                                    store: e,
                                                                    element: n,
                                                                    eventId: o,
                                        ...
                                        (a.actionTypeId === x || at(a.actionTypeId)) && gt({ store: n, actionListId: v, eventId: f });
                                    });
                                    var p = function (t) {
                                            var e = n.getState(),
                                                r = e.ixSession;
            ...
            (function (t) {
                G({
                    ...
                    onChange: function () {
                        lt(t), V({ store: t, elementApi: m }), ft({ store: t, allowEvents: !0 }), ot();
                    },
                });
            })(n)),
            ...
            if (f && f.useFirstGroupAsInitialState) {
                ...
                l.forEach(function (t) {
                    ...
                    a.forEach(function (i) {
                        ...
                        Tt({ destination: j({ element: i, actionItem: t, elementApi: m }, a), immediate: !0, store: e, element: i, eventId: r, actionItem: t, actionListId: n, pluginInstance: a });
                    });
                });
            }
        }
        function yt(t) {
            ...
            (0, v.default)(n, function (t) {
                if (!t.continuous) {
                    var n = t.actionListId,
                        r = t.verbose;
                    Ot(t, e), r && e.dispatch((0, y.actionListPlaybackChanged)({ actionListId: n, isPlaying: !1 }));
                }
            });
        }
        function mt(t) {
            ...
            (0, v.default)(u, function (t) {
                ...
                if (t.actionListId === o && t.eventId === n && a) {
                    ...
                    Ot(t, e), t.verbose && e.dispatch((0, y.actionListPlaybackChanged)({ actionListId: o, isPlaying: !1 }));
                }
            });
        }
        function It(t) {
            ...
            var I = (0 === u || (1 === u && y)) && at(v.action && v.action.actionTypeId) ? v.config.delay : void 0,
            ...
            return (
                T.forEach(function (t, a) {
                    ...
                    if (p) {
                        ...
                        M({ config: s, event: v, eventTarget: r, elementRoot: h, elementApi: m }).forEach(function (s, p) {
                            var v = d ? tt(l)(s, t) : null;
                            b = !0;
                            var h = S === a && 0 === p,
                                E = B({ element: s, actionItem: t }),
                                _ = j({ element: s, actionItem: t, elementApi: m }, v);
                            Tt({
                                store: e,
                                element: s,
                                actionItem: t,
        ...
        function bt(t, e) {
            ...
            if (K(b, O.mediaQueryKey) && (r || n || i)) {
                ...
                if (i) {
                    if (h) {
                        var D = It({ store: e, eventId: l, eventTarget: d, eventStateKey: p, actionListId: v, groupIndex: f + 1, verbose: _ });
    ...
    function (t, e, n) {
        n(100), n(102), n(27), n(104), n(257), n(258), n(259), n(260), n(261), (t.exports = n(262));
    },
    function (t, e, n) {
        "use strict";
        var r = n(4);
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n, E, _, g) {
            ...
            if (b && !O) return g || (g = new r()), y || f(t) ? i(t, e, n, E, _, g) : o(t, e, I, n, E, _, g);
            if (!(n & l)) {
                var A = O && h.call(t, "__wrapped__"),
                    w = S && h.call(e, "__wrapped__");
                if (A || w) {
                    var R = A ? t.value() : t,
                        L = w ? e.value() : e;
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n, r, T, S, b) {
            switch (n) {
                case I:
    ...
    function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }), (e.clearPlugin = e.renderPlugin = e.createPluginInstance = e.getPluginDestination = e.getPluginOrigin = e.getPluginConfig = void 0);
    ...
    function (t, e, n) {
                ...
                switch (o) {
                    ...
                    case m.STYLE_SIZE:
                        var u,
                            ...
                            l = i(t, g.HEIGHT);
                        return (
                            (u = a.widthUnit === g.AUTO ? (C.test(s) ? parseFloat(s) : parseFloat(n.width)) : (0, f.default)(parseFloat(s), parseFloat(n.width))),
                                (c = a.heightUnit === g.AUTO ? (C.test(l) ? parseFloat(l) : parseFloat(n.height)) : (0, f.default)(parseFloat(l), parseFloat(n.height))),
                ...
                switch (i) {
                    ...
                    case m.STYLE_SIZE:
                        var s = r.getStyle,
                            ...
                            E = h.widthValue,
                            y = h.heightValue;
                        if (!I.IS_BROWSER_ENV) return { widthValue: E, heightValue: y };
                        if (p === g.AUTO) {
                            var T = s(e, g.WIDTH);
                    ...
                    case m.STYLE_TEXT_COLOR:
                        var S = n.config,
                            ...
                            w = S.bValue,
                            R = S.aValue;
                        return { rValue: b, gValue: A, bValue: w, aValue: R };
                    case m.STYLE_FILTER:
                    ...
                    case g.RENDER_TRANSFORM:
                        return (function (t, e, n, r, i) {
                            ...
                            V(t, I.TRANSFORM_PREFIXED, i),
                                ...
                                (l = c.yValue),
                                (d = c.zValue),
                            ((s === m.TRANSFORM_MOVE && void 0 !== d) || (s === m.TRANSFORM_SCALE && void 0 !== d) || (s === m.TRANSFORM_ROTATE && (void 0 !== f || void 0 !== l))) && a(t, I.TRANSFORM_STYLE_PREFIXED, g.PRESERVE_3D);
                            var u, c, s, f, l, d;
                        })(t, e, n, i, a);
                    case g.RENDER_STYLE:
                            ...
                            switch (u) {
                                ...
                                case m.STYLE_TEXT_COLOR:
                                    var _ = O[u],
                                        ...
                                        S = n.aValue;
                                    V(t, _, o), a(t, _, S >= 1 ? "rgb(".concat(y, ",").concat(I, ",").concat(T, ")") : "rgba(".concat(y, ",").concat(I, ",").concat(T, ",").concat(S, ")"));
                                    break;
                                default:
                                    var b = c.unit,
                                        A = void 0 === b ? "" : b;
                                    V(t, i, o), a(t, i, n.value + A);
                            }
                        })(t, 0, n, i, o, a);
        ...
        var f = s(n(188)),
            ...
            S = Object.freeze(
                ((i = {}),
                    (0, c.default)(i, I.TRANSFORM_PREFIXED, g.TRANSFORM),
        ...
        function N(t) {
            ...
            var R,
                N,
                C,
                x = (0, p.default)(n, "action.config.affectedElements", {})[_ || T] || {},
                D = Boolean(x.id || x.selector),
                P = n && u(L(n.target));
            if ((D ? ((R = x.limitAffectedElements), (N = P), (C = u(x))) : (N = C = u({ id: _, selector: T, selectorGuids: O })), n && A)) {
                var M = r && (C || !0 === A) ? [r] : c(P);
                if (C) {
                    if (A === g.PARENT)
        ...
        function W(t) {
            ...
            e.actionItems.forEach(function (t) {
                var e,
                    i = t.actionTypeId,
                    o = t.config;
                (e = (0, _.isPluginType)(i) ? (0, _.clearPlugin)(i) : H({ effect: Y, actionTypeId: i, elementApi: r })), N({ config: o, event: n, elementApi: r }).forEach(e);
            });
        }
        var H = function (t) {
            var e = t.effect,
    ...
    function (t, e, n) {
        ...
        e.ixSession = function () {
            ...
            switch (e.type) {
                ...
                case v:
                    for (var b = e.payload, A = b.width, w = b.mediaQueries, R = w.length, L = null, N = 0; N < R; N++) {
                        var C = w[N],
                            x = C.key,
                            D = C.min,
                            P = C.max;
                    ...
                    return (0, i.merge)(t, { viewportWidth: A, mediaQueryKey: L });
                case h:
            ...
            m = function (t, e) {
                ...
                for (var S = 0, b = o.length; S < b; S++) {
                    ...
                    if ((0 === S && (h = R[0]), O >= w)) {
                        ...
                        var L = o[S + 1],
                            N = L && O !== w;
                        (E = N ? L.actionItems[0] : null), N && ((g = w / 100), (y = (L.keyframe - w) / 100));
                    }
                }
                var C = {};
                if (h && !E)
            ...
            I = function (t, e) {
                ...
                if (r && o) {
                    ...
                    if (s) {
                        var O = I - a,
                            S = y + m,
                            b = p(Math.min(Math.max(0, O / S), 1));
                        t = (0, i.set)(t, "verboseTimeElapsed", S * b);
                    }
                    if (T < 0) return t;
                    var A = p(Math.min(Math.max(0, T / y), 1)),
                        w = v(_, A),
                        R = {},
                        L = null;
                    return (
        ...
        e.ixInstances = function () {
            ...
            switch (e.type) {
                ...
                case f:
                    ...
                    if (!t[V]) return t;
                    for (var k = {}, B = Object.keys(t), W = B.length, H = 0; H < W; H++) {
                        var Y = B[H];
                        Y !== V && (k[Y] = t[Y]);
                    }
                    return k;
        ...
        var c,
            ...
            nt = function (t, e) {
                var n = t.store,
                    ...
                    l = et(n, f);
                return (
                    l && (0, h.stopActionGroup)({ store: n, eventId: f, eventTarget: i, eventStateKey: f + Q + o.split(Q)[1], actionListId: (0, p.default)(l, "action.config.actionListId") }),
                        (0, h.stopActionGroup)({ store: n, eventId: u, eventTarget: i, eventStateKey: o, actionListId: s }),
                        (0, h.startActionGroup)({ store: n, eventId: u, eventTarget: i, eventStateKey: o, actionListId: s }),
                        e
                );
            },
            rt = function (t, e) {
                    ...
                    (0, o.default)(r, D, {
                        ...
                        handler: function (t) {
                            ...
                            switch (u) {
                                ...
                                case K:
                                    var w = st(),
                                        ...
                                        N = w.scrollWidth,
                                        C = w.scrollHeight;
                                    S = T ? Math.min(R + y, N) / N : Math.min(L + I, C) / C;
                                    break;
                                case Y:
                                default:
                                    b = q(o, s);
                            ...
                            return (
                                ...
                                (u !== Y || A || A !== a.elementHovered) && ((S = f ? 1 - S : S), e.dispatch((0, E.parameterChanged)(b, S))),
                                    { elementHovered: A, clientX: v, clientY: _, pageX: y, pageY: I }
                            );
                        },
                    }),
                    (0, o.default)(r, H, {
                    ...
                    (0, o.default)(r, U, {
                        ...
                        handler: function (t) {
                            ...
                            if (d === z) {
                                ...
                                return S !== o.scrollPercent && n.dispatch((0, E.parameterChanged)(v, S)), { scrollPercent: S };
                            }
                            var b = q(i, v),
                                ...
                                R = (g ? O : 0) / 100;
                            (w = h ? w : 1 - w), (R = _ ? R : 1 - R);
                            var L = A.top + Math.min(A.height * w, l),
                                N = A.top + A.height * R - L,
                                C = Math.min(l + N, f),
                                x = Math.min(Math.max(0, l - L), C) / C;
                            return x !== o.scrollPercent && n.dispatch((0, E.parameterChanged)(b, x)), { scrollPercent: x };
                        },
                    }),
                    (0, o.default)(r, M, gt),
                    (0, o.default)(r, G, gt),
                    ...
                    (o.done = a.find("> .w-form-done")),
                        ...
                        o.fileUploads.each(function (e) {
                            !(function (e, n) {
                                ...
                                function A(t) {
                                    if (t) return S(t);
                                    a.toggle(!1), c.css("display", "inline-block"), (n.fileUploads[e].uploading = !1), w() || m(n);
                                }
                                function w() {
            ...
            (t.exports = function (t, e) {
                ...
                function g(e, n) {
                    ...
                    i.el.off(d),
                        ...
                        y(i),
                        o
                            ? (i.el.on("setting" + d, S(i)), O(i), (i.hasTimer = !1))
                            : (i.el.on("swipe" + d, S(i)),
                                i.left.on("tap" + d, I(i)),
                    ...
                    return function (i, a) {
                        ...
                        if (o && "setting" === i.type) {
                            ...
                            !(function (n, r) {
                                ...
                                null != i && b(n, { index: i, immediate: !0 });
                            })(n, a.select);
                        } else {
                            if ("swipe" === i.type) {
                            ...
                            n.nav.has(i.target).length && b(n, { index: t(i.target).index() });
                        }
                    };
                }
                function b(e, n) {
                    ...
                    var l = e.offsetX || 0,
                        ...
                        T = "opacity " + m + "ms " + y,
                        O = "transform " + m + "ms " + y;
                    if ((o || (h.each(v.intro), _.each(v.outro)), n.immediate && !u)) return s(h).set(p), void A();
                    if (e.index !== e.previous) {
                        if ("cross" === g) {
                            var S = Math.round(m - m * r.crossOver),
                                b = Math.round(m - S);
                            return (
                                (T = "opacity " + S + "ms " + y),
                ...
                function w(e) {
                    ...
                    var s = e.index;
                    s >= n && (s = n - 1), b(e, { immediate: !0, index: s });
                }
                return (
                    (c.ready = function () {
                        (o = r.env("design")), h();
...
Webflow.require("ix2").init({
    events: {
        "e-2": {
            ...
            target: { appliesTo: "PAGE", styleBlockIds: [], id: "5d4906e5d6bb3e49e6a3d70a" },
            config: { loop: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
            createdOn: 1565144564032,
        },
        "e-3": {
            id: "e-3",
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".fade-in", originalId: "b6631aaa-063e-743d-a300-6b886199de1d", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 100, startsEntering: true, addStartOffset: true, addOffsetValue: 10, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145319008,
        },
        "e-4": {
            id: "e-4",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".header-illustration", originalId: "5d4906e5d6bb3e49e6a3d70a|00eb0948-d5e7-4790-3cb2-984e957cbce1", appliesTo: "CLASS" },
        ...
        "e-5": {
            ...
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".h1.heading", originalId: "5d49c5fa79c912d573775848|17c2da2b-cbd4-790b-87ce-bf1a9f083f61", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 50, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145582322,
        },
        "e-6": {
            id: "e-6",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".h1.sub-heading", originalId: "5d49c5fa79c912d573775848|12444569-96f4-9a37-ceff-4724d8f7aed1", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 50, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145599299,
        },
        "e-7": {
            id: "e-7",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".heading", originalId: "5d49c5fa79c912d573775848|74a7f529-91ba-c286-8e1c-55c5a49dac97", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145640348,
        },
        "e-8": {
            id: "e-8",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".sub-heading", originalId: "5d49c5fa79c912d573775848|069c5d93-0b60-e479-b1de-4daf6dd43651", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145662111,
        },
        "e-9": {
            id: "e-9",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".text", originalId: "5d49c5fa79c912d573775848|959eae00-5b74-f0b9-2470-e4ffc0a21aab", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145690962,
        },
        "e-10": {
            id: "e-10",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".button", originalId: "5d49c5fa79c912d573775848|696cd802-2507-e05b-8209-bdda849fa1c3", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 100, startsExiting: true, addEndOffset: false, endOffsetValue: 100 }],
            createdOn: 1565145704186,
        },
        "e-11": {
            id: "e-11",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".pre-heading", originalId: "5d4906e5d6bb3e49e6a3d70a|6670c7d3-914b-50e5-7e9a-7793e2980af4", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145768130,
        },
        "e-12": {
            id: "e-12",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".press-logo", originalId: "5d4906e5d6bb3e49e6a3d70a|04bd42e3-bb57-06fa-f8ad-96bbd066e127", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145776600,
        },
        "e-13": {
            id: "e-13",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".figure", originalId: "5d4906e5d6bb3e49e6a3d70a|5cd91af5-bf83-a899-8765-2b8724b9a9f9", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145791656,
        },
        "e-14": {
            id: "e-14",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".pricing-card", originalId: "5d4906e5d6bb3e49e6a3d70a|52d4a506-4619-d6f3-f9d1-74beba9ff1fd", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145826205,
        },
        "e-15": {
            id: "e-15",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".pricing-number", originalId: "5d4906e5d6bb3e49e6a3d70a|1f7e9b77-50d4-827a-9f40-37e2c491e154", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145842073,
        },
        "e-16": {
            id: "e-16",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".pricing-list-item", originalId: "5d4906e5d6bb3e49e6a3d70a|44e354d7-43d2-bc98-61f0-66638b829703", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145853462,
        },
        "e-17": {
            id: "e-17",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".testimonial-person", originalId: "5d4906e5d6bb3e49e6a3d70a|1c3e94d0-a306-d34a-aaf2-5d567e8b54b9", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145879188,
        },
        "e-18": {
            id: "e-18",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".testimonial-quote", originalId: "5d4906e5d6bb3e49e6a3d70a|a6f0b69b-c4b4-13fd-fc82-00c04ac2a732", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145889177,
        },
        "e-19": {
            id: "e-19",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".footer-logo", originalId: "5d4906e5d6bb3e49e6a3d70a|8592e4aa-f25e-d706-e3f3-f4d088c55d5d", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145901433,
        },
        "e-20": {
            id: "e-20",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".footer-link", originalId: "5d4906e5d6bb3e49e6a3d70a|34754034-abfe-8d20-3080-ae8e62319df4", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145911230,
        },
        "e-21": {
            id: "e-21",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d4906e5d6bb3e49e6a3d70a|604143db-6433-9dc0-c07a-4724fdd04c3f" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145923721,
        },
        "e-22": {
            id: "e-22",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".social-link", originalId: "5d4906e5d6bb3e49e6a3d70a|39be05c6-3b92-12d5-33cf-11154dd0cb54", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145935924,
        },
        "e-24": {
            id: "e-24",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".newsletter-form", originalId: "2757ad9e-d417-6d97-31a1-bf3228c73438", appliesTo: "CLASS" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565145962657,
        },
        "e-25": {
            id: "e-25",
            eventTypeId: "SCROLLING_IN_VIEW",
            action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-2", affectedElements: {}, duration: 0 } },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { appliesTo: "ELEMENT", styleBlockIds: [], id: "5d4af46c8f3da1a366b8394e|8cb576fd-551d-fde6-508b-2878922d92e6" },
            config: [{ continuousParameterGroupId: "a-2-p", smoothing: 80, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
            createdOn: 1565194369311,
        },
        "e-26": {
            id: "e-26",
            eventTypeId: "SCROLL_INTO_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", config: { actionListId: "fadeIn", autoStopEventId: "e-27" }, instant: false },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".footer-copyright", originalId: "5d4906e5d6bb3e49e6a3d70a|366e3c40-2af6-7323-b12f-35017e33935c", appliesTo: "CLASS" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: true },
            createdOn: 1565195061059,
        },
        "e-27": {
            id: "e-27",
            eventTypeId: "SCROLL_OUT_OF_VIEW",
            action: { id: "", actionTypeId: "FADE_EFFECT", config: { actionListId: "fadeOut", autoStopEventId: "e-26" }, instant: false },
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: { selector: ".footer-copyright", originalId: "5d4906e5d6bb3e49e6a3d70a|366e3c40-2af6-7323-b12f-35017e33935c", appliesTo: "CLASS" },
            config: { loop: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: 0, direction: null, effectIn: false },
            createdOn: 1565195061095,
        },
    },
    actionLists: {
        a: {
            ...
            actionItemGroups: [
                {
                    actionItems: [
                        { id: "a-n", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, value: "block", target: { selector: ".loader", selectorGuids: ["ae3ab505-7c8d-ca3e-09c0-9c067f9391b0"] } } },
                        { id: "a-n-30", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { id: "5811b10d-06b9-79ea-d6a7-81a39c483bab" }, value: 1, unit: "" } },
                        {
                            id: "a-n-11",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".page-load.fade-one", selectorGuids: ["6e5a3df2-ff82-1a6d-71d0-db926f0b0957", "dc650d39-9ddf-40c1-920e-1501de7b1108"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-n-10",
                            ...
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".page-load.fade-one", selectorGuids: ["6e5a3df2-ff82-1a6d-71d0-db926f0b0957", "dc650d39-9ddf-40c1-920e-1501de7b1108"] },
                                yValue: 20,
                                xUnit: "PX",
                                yUnit: "PX",
                                zUnit: "PX",
                        ...
                        },
                        {
                            id: "a-n-12",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".page-load.fade-two", selectorGuids: ["6e5a3df2-ff82-1a6d-71d0-db926f0b0957", "bd6d49cd-dbdd-7d09-ad07-466c667c60c5"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-n-13",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".page-load.fade-two", selectorGuids: ["6e5a3df2-ff82-1a6d-71d0-db926f0b0957", "bd6d49cd-dbdd-7d09-ad07-466c667c60c5"] },
                                yValue: 20,
                                xUnit: "PX",
                                yUnit: "PX",
                                zUnit: "PX",
                        ...
                        },
                        {
                            id: "a-n-14",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".page-load.fade-three", selectorGuids: ["6e5a3df2-ff82-1a6d-71d0-db926f0b0957", "378d6972-2a42-4dee-6179-801dc87dd759"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-n-15",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".page-load.fade-three", selectorGuids: ["6e5a3df2-ff82-1a6d-71d0-db926f0b0957", "378d6972-2a42-4dee-6179-801dc87dd759"] },
                                yValue: 20,
                                xUnit: "PX",
                                yUnit: "PX",
                                zUnit: "PX",
                        ...
                        },
                        {
                            id: "a-n-16",
                            actionTypeId: "STYLE_OPACITY",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".page-load.fade-four", selectorGuids: ["6e5a3df2-ff82-1a6d-71d0-db926f0b0957", "53deec0d-d3a3-23de-5b3f-a0425da60dd8"] }, value: 0, unit: "" },
                        },
                        {
                            id: "a-n-17",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: {
                                ...
                                easing: "",
                                duration: 500,
                                target: { selector: ".page-load.fade-four", selectorGuids: ["6e5a3df2-ff82-1a6d-71d0-db926f0b0957", "53deec0d-d3a3-23de-5b3f-a0425da60dd8"] },
                                yValue: 20,
                                xUnit: "PX",
                                yUnit: "PX",
                                zUnit: "PX",
                        ...
                        { id: "a-n-18", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { selector: ".nav", selectorGuids: ["644e4765-b80b-fd19-3a21-e96b58fef28b"] }, value: 0, unit: "" } },
                        {
                            id: "a-n-19",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 0, easing: "", duration: 500, target: { selector: ".nav", selectorGuids: ["644e4765-b80b-fd19-3a21-e96b58fef28b"] }, yValue: -100, xUnit: "PX", yUnit: "PX", zUnit: "PX" },
                        },
                    ],
                },

                { actionItems: [{ id: "a-n-9", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, value: "none", target: { selector: ".loader", selectorGuids: ["ae3ab505-7c8d-ca3e-09c0-9c067f9391b0"] } } }] },
                {
                    actionItems: [
                        {
                            id: "a-n-20",
                        ...
                        { id: "a-n-28", actionTypeId: "STYLE_OPACITY", config: { delay: 320, easing: "outQuad", duration: 500, target: { selector: ".nav", selectorGuids: ["644e4765-b80b-fd19-3a21-e96b58fef28b"] }, value: 1, unit: "" } },
                        {
                            id: "a-n-29",
                            actionTypeId: "TRANSFORM_MOVE",
                            config: { delay: 320, easing: "outQuad", duration: 500, target: { selector: ".nav", selectorGuids: ["644e4765-b80b-fd19-3a21-e96b58fef28b"] }, yValue: 0, xUnit: "PX", yUnit: "PX", zUnit: "PX" },
                        },
                        {
                            id: "a-n-24",
                            actionTypeId: "STYLE_OPACITY",
                            ...
                            actionItems: [
                                {
                                    id: "a-2-n",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "b6631aaa-063e-743d-a300-6b886199de1d" }, yValue: 20, xUnit: "PX", yUnit: "PX", zUnit: "PX" },
                                },
                                { id: "a-2-n-3", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "b6631aaa-063e-743d-a300-6b886199de1d" }, value: 0, unit: "" } },
                            ],
                        },
                        {
                            keyframe: 14,
                            actionItems: [
                                {
                                    id: "a-2-n-4",
                                    actionTypeId: "TRANSFORM_MOVE",
                                    config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "b6631aaa-063e-743d-a300-6b886199de1d" }, yValue: 0, xUnit: "PX", yUnit: "PX", zUnit: "PX" },
                                },
                                { id: "a-2-n-5", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "b6631aaa-063e-743d-a300-6b886199de1d" }, value: 1, unit: "" } },
                            ],
                        },
                        {
                            keyframe: 99,
                            actionItems: [{ id: "a-2-n-6", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "b6631aaa-063e-743d-a300-6b886199de1d" }, value: 1, unit: "" } }],
                        },
                        {
                            keyframe: 100,
                            actionItems: [{ id: "a-2-n-7", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "b6631aaa-063e-743d-a300-6b886199de1d" }, value: 0, unit: "" } }],
                        },
                    ],
                },
            ],
            createdOn: 1565145322930,
        },
        fadeIn: {
            id: "fadeIn",
            useFirstGroupAsInitialState: true,
